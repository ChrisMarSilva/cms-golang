...
// Este canal é usado para enviar cada palavra lida em várias rotinas.
// 	channel := make(chan (string))

// 	// A dictionary which stores the count of unique words.
// Um dicionário que armazena a contagem de palavras únicas.
// 	dict := make(map[string]int64)

// 	// Done is a channel to signal the main thread that all the words have been entered in the dictionary.
// Pronto é um canal para sinalizar ao thread principal que todas as palavras foram inseridas no dicionário.
