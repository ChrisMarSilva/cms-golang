...
var dbSqlServerGorm *gorm.DB

type DatabaseSQLServerGorm struct {
}

func (DatabaseSQLServerGorm) StartDB() {
	...
	dbSqlServerGorm = database
}

func (DatabaseSQLServerGorm) GetDatabase() *gorm.DB {
	return dbSqlServerGorm
}

func (DatabaseSQLServerGorm) Close() {
}
