...
// go mod init github.com/chrismarsilva/cms.golang.teste.web.crawler.google
...
func main() {
	searchTerm := "350.344.118-22" // "Cristiano Martins da Silva" // "akhil sharma"
	countryCode := "br" // com // br 
	languageCode := "pt-br" // en // pt-br 
	// proxyString := nil
	pages := 1
	count := 30
	backoff := 10
	res, err := GoogleScrape(searchTerm, countryCode, languageCode, nil, pages, count, backoff)
	if err == nil{
		for _, res := range res{
			fmt.Println(res)
		}
