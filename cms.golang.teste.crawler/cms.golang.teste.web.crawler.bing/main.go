...
// go mod init github.com/ChrisMarSilva/cms.golang.teste.web.crawler.bing
...
func main() {
	...
	searchTerm := "Cristiano Martins da Silva" // "Chris MarSil" // "akhil sharma"
	country := "com"
	// proxyString := nil
	pages := 1
	count := 15
	...
	res, err := BingScrape(searchTerm, country, nil, pages, count, backoff)
	if err != nil {
		fmt.Println(err)
		return
	}
