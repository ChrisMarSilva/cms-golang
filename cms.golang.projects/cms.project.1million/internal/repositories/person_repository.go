...
func NewPersonRepository(logger *slog.Logger, db *stores.Database) *PersonRepository {
...
func (r *PersonRepository) Add(ctx context.Context, model models.PersonModel) error {
	...
	defer span.End()
	span.SetAttributes(attribute.String("id", model.ID.String()), attribute.String("name", model.Name), attribute.String("created_at", model.CreatedAt.String()))
...
func (r *PersonRepository) Update(ctx context.Context, model *models.PersonModel) error {
	...
	defer span.End()
	span.SetAttributes(attribute.String("id", model.ID.String()), attribute.String("name", model.Name))
